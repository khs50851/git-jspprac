	...
	<div class="container">
		<div class="location">
			<div class="col-md-offset-3">
				<h3 class="font-bold1 pull-left marginleft10">이벤트</h3>
			</div>
			<ol class="breadcrumb pull-right">
				<li><a href="index.jsp">HOME</a></li>
				<li class="freeboard.jsp">이벤트</li>
				<!-- active는 활성화된 현재위치 -->
			</ol>
		</div>
	</div>
...
<div class="col-md-3">
		<div class="lnBox">
			...
			<img src="images/event1.jpg" alt="sample70" />
		</div>
			...
			<div class="contentInner">
						<article class="eventArticle">
							<div class="artColumn">
								<figure class="eventImage"><a href="https://www.yomiuriland.com/wai/index.html" target="_blank"><img src="images/eventb1.jpg" alt=""></a></figure>
								<div class="detail">
									<h2 class="artHead"><a href="https://www.yomiuriland.com/wai/index.html" target="_blank">【チケットは日付指定の予約制】プールWAI　7/18(土)OPEN！！</a></h2>
									<p class="artPeriod">7/18(土)OPEN！</p>
									<p class="detailLink"><a href="https://www.yomiuriland.com/wai/index.html" target="_blank"><span>詳細はこちら</span></a></p>
									<!--detail-->
								</div>
								<!--articleColumn-->
							</div>
						...
						<article class="eventArticle">
							<div class="artColumn">
								<figure class="eventImage"><a href="detailevent2.do" target="_blank"><img src="images/eventb2.jpg" alt=""></a></figure>
								<div class="detail">
									<h2 class="artHead"><a href="detailevent2.do" target="_blank">来年(2021年)春(予定)！グッジョバ!!に「SPACE factory」誕生！パートナー企業は大正製薬</a></h2>
									<p class="artPeriod">7/18(土)OPEN！</p>
									<p class="detailLink"><a href="detailevent2.do" target="_blank"><span>詳細はこちら</span></a></p>
									<!--detail--
								</div>
