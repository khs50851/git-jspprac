...
<body>
	<div id="wrap1">
		<br>
		<b><font size="5" color="gray">コメント回答</font></b>
		<hr size="1" width="550">
		<br>
		<div id="commentReplyForm">
			<form name="replyInfo" target="parentForm">
				<textarea rows="7" cols="70" name="comment_content" id="comment_content" placeholder="コメントを入力してください。"></textarea>
				<br><br>
...
function checkValue(){
	...
	$.ajax({
		type:"post",
		dataType:"json",
		data:{comment_num:"${cvo1.commentnumber}",article_number:"${cvo1.article_number}",userid:"${userid}",comment_content:$("#comment_content").val()},
		async:false,
		url:"commentreplyaction2.do",
