	...
	var count4 = 0;
	 ...
	 $('#goods_cnt2').on('change', function() {
			...
			item2 = $("#goods_cnt2").val() * $("#goods_Item_Price2").val()
			 ...
			 sum2 = sum+item2
			 $("#total_price").text(item1+item2)
			 
			 
			 count2 = Number(count) + Number($("#goods_cnt2").val());
				$("#total").text(count2)
	 ...
	 $('#goods_cnt3').on('change', function() {
			...
			item3 = $("#goods_cnt3").val() * $("#goods_Item_Price3").val()
			 $(".itemPrice3").text(item3)
			  sum3 = sum2+item3
			 $("#total_price").text(item1+item2+item3)


			 
			 count3 = Number(count2) + Number($("#goods_cnt3").val());
			$("#total").text(count3)
	 ...
	 $('#goods_cnt4').on('change', function() {
			...
			item4 = $("#goods_cnt4").val() * $("#goods_Item_Price4").val()
			 ...
			 $("#total_price").text(item1+item2+item3+item4)
			  ...
			  count4 = Number(count3) + Number($("#goods_cnt4").val());
			$("#total").text(count4)
